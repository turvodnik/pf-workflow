...
3. Сводка человеку: таблица (id, суть, зависит от, исполнитель), что можно параллельно, и готовая команда запуска первой партии: новая сессия → «выполни task-пакет T-00N по pf-do».
